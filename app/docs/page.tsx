...
export default function Docs() {
  ...
  return (
    <>
      ...
      <div className="docs-content-wrapper" style={{ maxWidth: 'var(--container-max)', margin: '0 auto', padding: '0 24px' }}>
          ...
          <main className="docs-main-content">
            ...
            <section id="installation" className="doc-section reveal" ref={addToRefs}>
              ...
              <div className="docs-card">
                ...
                <p>The setup script applies the <span className="mono">arm-generic-fdt</span> patches and builds QEMU as a module-aware emulator.</p>
                <pre className="mono">
                  make setup<br />
                  make venv<br />
            ...
            <section id="architecture" className="doc-section reveal" ref={addToRefs}>
              ...
              <div className="docs-features-grid">
                {[
                  ...
                  { title: 'Deterministic Communication', desc: 'Virtual-timestamped delivery for Ethernet and UART, ensuring causal ordering across nodes without wall-clock scheduling.' },
                  { title: 'SAL/AAL Boundary', desc: 'Bridging firmware and physics. Translates raw MMIO register values into continuous physical properties like force and torque.' },
                  { title: 'Dynamic QOM Plugins', desc: 'Eliminates recompiling QEMU. Peripherals compile to .so modules and are auto-discovered at runtime.' },
                  { title: 'Co-Simulation Models', desc: 'SystemC TLM-2.0 integration for co-simulation with external Verilated models and FPGA hardware over UDP.' }
                ].map((item, i) => (
            ...
            <section id="sync" className="doc-section reveal" ref={addToRefs}>
              ...
              <div className="docs-sync-box">
                <ul>
                  <li>
                    <strong>Standalone:</strong> Free-running TCG at maximum host speed. Used for development and CI.
                  </li>
                  <li>
                    <strong>Slaved-Suspend:</strong> Cooperative halting at TB boundaries. ~95% throughput. Recommended for most FirmwareStudio workloads.
                  </li>
                  <li>
                    <strong>Slaved-Icount:</strong> Exact nanosecond virtual time. Required for firmware measuring sub-quantum intervals (PWM, µs DMA).
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section id="faq" className="doc-section reveal" ref={addToRefs}>
              ...
              <div className="docs-features-grid">
                {[
                  { q: 'How should I approach learning the system?', a: 'Start with the tutorials in the `tutorial/` folder. Lessons 1 & 2 cover QEMU internals, 5 & 9 cover SystemC, and 7 covers the Zenoh message bus.' },
                  { q: 'Why no Python in the simulation loop?', a: 'Python\'s GIL and garbage collector introduce milliseconds of latency. We write native C plugins (.so files) that achieve near-native performance for MMIO. Python is strictly reserved for offline tooling.' },
                  { q: 'Why Zenoh instead of sockets?', a: 'Standard sockets ruin determinism because the host OS network stack introduces random latency. Zenoh provides virtual-timestamped delivery across nodes, guaranteeing causal ordering.' },
                  { q: 'How do I add a new peripheral?', a: 'Start with `hw/dummy/dummy.c` as a learning template. Do not copy-paste complex upstream QEMU peripheral code without understanding it; start simple and build up.' },
                ].map((faq, i) => (
